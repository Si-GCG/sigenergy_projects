        ...
        try:
            async with async_timeout.timeout(60):
                ...
                if self.data is None:
                    ...
                    for inverter_name, dc_data in dc_charger_data.items():
                        if inverter_name not in self.data["dc_chargers"]:
                            self.data["dc_chargers"][inverter_name] = {}
                        self.data["dc_chargers"][inverter_name].update(dc_data)
                # --- End Merge ---
